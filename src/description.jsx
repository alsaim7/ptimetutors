        ...
        <>
            ...
            <div className='container d-flex justify-content-md-center gap-5 mb-5 flex-column flex-md-row align-items-center align-items-md-start'>
                ...
                <div className="cardF2 card mt-3 desCard" style={{ width: "18rem" }}>
                    <img src="https://res.cloudinary.com/dnkqy2kkr/image/upload/c_thumb,w_200,g_face/v1737121988/ques_kkl9zf.jpg" className="card-img-top" alt="services"/>
                    <div className="card-body">
                ...
                <div className="cardF3 card mt-3 mb-5 desCard" style={{ width: "18rem" }}>
                    <img src="https://res.cloudinary.com/dnkqy2kkr/image/upload/c_thumb,w_200,g_face/v1737121988/ques_kkl9zf.jpg" className="card-img-top" alt="form"/>
                    <div className="card-body">
